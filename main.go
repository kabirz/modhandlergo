...
func init() {
	...
	application.RegisterEvent[map[string]any]("lora:log")
	application.RegisterEvent[int]("lora:connstate")
	application.RegisterEvent[map[string]any]("lora:frame")
