...
const LoraConfigCard = memo(function LoraConfigCard() {
  ...
  const [loraMode, setLoraMode] = useState(2);
  const [loraCh1Spd, setLoraCh1Spd] = useState(7);
  const [loraCh1Freq, setLoraCh1Freq] = useState(4700);
  ...
  const [loraNid, setLoraNid] = useState(0x01020304);
  const [loraGwid, setLoraGwid] = useState(0x11223344);
  const [loraGwidInput, setLoraGwidInput] = useState("11223344");
